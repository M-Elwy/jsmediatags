 ...
 */
export const bin = function (string: string): ByteArray {
 ...
 */
export const pad = function (array: Array<any>, size: number): Array<any> {
...
// as $00 00 02 01.
export const getSynchsafeInteger32 = function (number: number): ByteArray {
  // 0x7f = 0b01111111
  return [
    (number >> 21) & 0x7f,
    (number >> 14) & 0x7f,
...
export const getInteger32 = function (number: number): ByteArray {
  return [
    (number >> 24) & 0xff,
    (number >> 16) & 0xff,
    (number >> 8) & 0xff,
...
export const getInteger24 = function (number: number): ByteArray {
